...
class Library_oauth2_client {
    ...
    /**
     * Defenisikan informasi yang dibutuhkan yaitu:
     * client id, client secreet dan url callback.
     * Selain url callback informasi lainnya bisa
     * didapatkan dari OAuth Provider.
     */
