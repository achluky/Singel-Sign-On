                ...
                <div class="card">
                    ...
                    <div class="card-body">                        
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="name" value="<?php echo $result->name?>" disabled>  
                      </div>
                      <div class="form-group">
                        <label>Email PIC</label>
                        <input type="email" class="form-control" required="" name="pic" value="<?php echo $result->pic?>" disabled>
                      </div>
                      <div class="form-group">
                        <label>Redirect URL</label>
                        <input type="text" class="form-control" name="redirect_url" value="<?php echo $result->redirect_url?>" disabled>
                      </div>
                      <div class="form-group">
                        <label>Logout URL</label>
                        <input type="text" class="form-control" name="logout_url" value="<?php echo $result->logout_url?>" disabled>
                      </div>
                    </div>
                    <div class="card-footer text-left">
                      <a href="<?php echo $this->config->item('sp');?>client/daftar" class="btn btn-primary">Back</a>
                    </div>
                </div>
          </div>
